...
export default new Catalog<Vocabulary>("ja", {
    ...
    "bot/bumpReminder/start": msg("Bumpのリマインド機能を開始しました。サーバー：{guild}"),
    "bot/bumpReminder/stop": msg("Bumpのリマインド機能を停止しました。サーバー：{guild}"),
    "bot/bumpReminder/detectBump": msg("Bumpのリマインド機能を実行中にBumpを検知しました。サーバー：{guild}"),
    "bot/bumpReminder/setRemindLog": msg("Bumpのリマインドを設定しました。サーバー：{guild}"),
    "bot/bumpReminder/cancelRemindLog": msg("Bumpのリマインドをキャンセルしました。サーバー：{guild}"),
    "bot/bumpReminder/remindLog": msg("Bumpのリマインドをしました。サーバー：{guild}"),
